...
Mvis.PC0.gls <- gls(PC_sq ~ visual, data = warp_mod, na.action = na.omit)
...
df_PCvis
PC_vis<-df_PCvis[df_PCvis$pFDR <= 0.05, ] 
PC_vis
```
...
df_PCsensory
PC_sensory<-df_PCsensory[df_PCsensory$pFDR <= 0.05, ] 
PC_sensory
```
...
nos<- subset(graph_df, graph_df$group == "normal")
