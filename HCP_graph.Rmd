...
```{r}
mod_function<-function(num,data){
...
```{r}
chisq.test(table(graph_df$group, graph_df$modules))
pAll<-balloonplot(table(graph_df$group, graph_df$modules), main ="Module Frequencies by group", xlab ="", ylab="",
            label = TRUE, show.margins = FALSE, colsrt = 90, text.size=1 ,dotsize = 5, colmar=5, dotcolor='grey')
# By Mod
mod_function(0,graph_df)
```
...
balloonplot(table(no_$modules, no_$area), main ="Module Frequencies per functional network average BMI", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[1])

no_2<-subset(no_, no_$modules == 2)
...
no_4<-subset(no_, no_$modules == 4)
balloonplot(table(no_4$node_type, no_4$area), main ="Module Frequencies per functional network average BMI subcortical", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[1])

ov_<-subset(graph_df, graph_df$group == "overweight")
balloonplot(table(ov_$modules, ov_$area), main ="Module Frequencies per functional network high BMI", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[2])

ov_0<-subset(ov_, ov_$modules == 0)
balloonplot(table(ov_0$node_type, ov_0$area), main ="Module Frequencies per functional network high BMI", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[2])

ov_5<-subset(ov_, ov_$modules == 5)
balloonplot(table(ov_5$node_type, ov_5$area), main ="Module Frequencies per functional network high BMI module 5", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[2])


ob_<-subset(graph_df, graph_df$group == "obese")
balloonplot(table(ob_$modules, ob_$area), main ="Module Frequencies per functional network very high BMI", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[3])

ob_2<-subset(ob_, ob_$modules == 2)
balloonplot(table(ob_2$node_type, ob_2$area), main ="Module Frequencies per functional network very high BMI", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[3])

ob_6<-subset(ob_, ob_$modules == 6)
balloonplot(table(ob_6$node_type, ob_6$area), main ="Module Frequencies per functional network very high BMI module 6", xlab ="", ylab="", label = TRUE, show.margins = FALSE, colsrt = 90, text.size=x ,dotsize = 5, colmar=5, dotcolor=cbPalette[3])
```

Module summaries
Average weight
0 - Visual
1 - Fronto-medial parietal and cerebellum and DMN
2 - Amygdala, auditory, hand mouth, and visual
3 - Cerebellum, CO, dorsal attention
4 - Cerebellum
5 - cerebellum, caudate, putamen, thalamus, VDia
6 - brain stem
7 - brain stem, thalamus
8 - brain stem

High weight
0 - Visual
1 - Amygdala, cerebellum, DMN, fronto-parietal 
2 - Visual, hand mouth, dorsal attn
3 - Cerebellum, CO, Fronto-parietal
4 - Cerebellum
5 - caudate, putamen, thalamus, VDia
6 - Brain stem
7 - brain stem

Very high weight
0 - Visual
1 - Cerebellum, DMN, fronto-parietal
2 - Auditory, brainstem, CO, DAttn, Visual, hand mouth
3 - Cerebelllum, CO
4 - Amygdala, cerebellum, DMN
5 - Fronto-parietal
6 - Caudate, putamen, thalamus
7 - brainstem
8 - brain stem, VDia
```{r}
